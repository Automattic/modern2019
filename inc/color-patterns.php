 ...
 */
function modern2019_custom_colors_css() {
	...
	/**
	 * Filter Modern (Twenty Nineteen) default saturation level.
	 *
	 * @since Modern (Twenty Nineteen) 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'modern2019_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter Modern (Twenty Nineteen) default selection saturation level.
	 *
	 * @since Modern (Twenty Nineteen) 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'modern2019_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter Modern (Twenty Nineteen) default lightness level.
	 *
	 * @since Modern (Twenty Nineteen) 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'modern2019_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter Modern (Twenty Nineteen) default hover lightness level.
	 *
	 * @since Modern (Twenty Nineteen) 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'modern2019_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter Modern (Twenty Nineteen) default selection lightness level.
	 *
	 * @since Modern (Twenty Nineteen) 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'modern2019_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters Modern (Twenty Nineteen) custom colors CSS.
	 *
	 * @since Modern (Twenty Nineteen) 1.0
	 *
	 ...
	 */
	return apply_filters( 'modern2019_custom_colors_css', $theme_css, $primary_color, $saturation );
}
